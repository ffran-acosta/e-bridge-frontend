...
interface AltaConsultationModalProps {
  isOpen: boolean;
  onClose: () => void;
  patientId: string;
  patientName: string;
...
export function AltaConsultationModal({
  isOpen,
  onClose,
  patientId,
  patientName,
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      ...
      >
        <DialogHeader className="flex-shrink-0 pb-6 border-b">
          <DialogTitle className="sr-only">Consulta de Alta</DialogTitle>
          <DialogDescription className="sr-only">
            Formulario para crear una consulta de alta médica
          </DialogDescription>
        </DialogHeader>
